...
object ColumnDataType {
  ...
  def catalystDataType(cassandraType: connector.types.ColumnType[_], nullable: Boolean): types.DataType = {
    ...
    def catalystStructField(field: FieldDef): types.StructField =
      types.StructField(field.fieldName, catalystDataType(field.fieldType, nullable = true), nullable = true)
